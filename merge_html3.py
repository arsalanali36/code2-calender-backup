...
def inject_grid():
    ...
    if '<!-- The dash-grid is injected here by our JS -->' in vd_content:
        ...
        with io.open('templates/visual_dashboard.html', 'w', encoding='utf-8') as f:
            f.write(vd_content)
        print("Injected into visual_dashboard.html successfully!")
    else:
        print("COULD NOT FIND PLACEHOLDER IN VISUAL_DASHBOARD.HTML!")
