...
<body>
  ...
  <main class="app-main">
    ...
    <section class="section visual-dashboard-section" style="margin-top: 20px;">
      ...
      <div class="visual-dash-wrapper" style="padding: 20px;">
  ...
  <script src="/static/js/visual-dashboard.js"></script>
</body>
...
<div class="modal-overlay gv2-modal" id="gallery-modal">
  ...
  <div class="gv2-tray">
    ...
    <div class="gv2-tray-btns">
      ...
      <button class="gv2-tray-btn gv2-toggle-btn" id="gv2-time-btn" title="Show Save Time">&#128338; Time</button>
    </div>
